<template>
  <div class="w-full h-full lg:h-72 my-4 transition-shadow duration-300 flex flex-col lg:flex-row bg-gray-50 ring-1 ring-gray-300 ring-opacity-60 hover:ring-opacity-80 rounded-xl hover:shadow-lg">
    ...
    <div class="h-full w-full rounded-l-xl overflow-hidden py-5 px-8">
      <div class="flex items-start justify-between">
        <div class="inline-block">
          ...
          <span class="text-xs text-gray-700 inline-flex space-x-1 items-center mt-2">
            ...
            <p> {{blog.readTime}}  min of read</p>
          </span>
        </div>
        <div class="inline-flex items-center space-x-2 mt-1">
          <button class="transition hover:text-green-secondary text-gray-500 focus:outline-none rounded">
      ...
      <p class="mt-4 font-normal">{{ blog.highlight }}</p>
      <div class="w-full h-full flex justify-end">
        <button class="text-sm text-gray-700 transition inline-flex space-x-1 items-start focus:outline-none hover:text-green-secondary">
          <span> Read more story</span>
          <svg class="w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
